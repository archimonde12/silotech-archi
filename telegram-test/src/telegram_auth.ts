...
const checkHash = (_botToken: string, _userData: TelegramUserData) => {
    //Formula hash at: https://core.telegram.org/widgets/login
    // Sample PHP code for checking authorization and receiving data: https://gist.github.com/anonymous/6516521b1fb3b464534fbc30ea3573c2
